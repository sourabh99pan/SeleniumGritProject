...
public class TC_01_MPPowerscreenLead extends TestBase {

	public static ExtentReports extent;
	private String sTestCaseName;
	private int iTestCaseRow;

	@Test(dataProvider = "LeadCreation", groups = { "functest" })

	public void TC01MPPowerscreenLead(String user, String pwd, String LeadOwner, String Salutation_Name,
			String First_Name, String Last_Name, String Phone, String Company, String EmailId, String CustType,
			String BUType, String Queue_User, String Lead_Name) throws IOException, InterruptedException {
		...
		obj1.addNewLead(user, pwd, LeadOwner, Salutation_Name, First_Name, Last_Name, Phone, Company, EmailId, CustType,
				BUType);
	...
	// Excel Data Picker
	@DataProvider(name = "LeadCreation")
