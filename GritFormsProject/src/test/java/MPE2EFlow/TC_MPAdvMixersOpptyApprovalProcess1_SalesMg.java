...
public class TC_MPAdvMixersOpptyApprovalProcess1_SalesMg extends TestBase {
	...
	public void TC_11_MPAdvMixersOpptyApprovalProcess1_SalesMg(String Username, String Password, String LoginUser,
		...
		if (num2 >= 0) {
			test.pass("Variance from Generated Discount greater then expected'" + VarianceGeneratedDiscount);
		} else {
			test.fail("Variance from Generated Discount not greater then expected'" + VarianceGeneratedDiscount);
		}
