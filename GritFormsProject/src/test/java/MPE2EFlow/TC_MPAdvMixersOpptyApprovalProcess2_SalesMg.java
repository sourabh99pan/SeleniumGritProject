...
public class TC_MPAdvMixersOpptyApprovalProcess2_SalesMg extends TestBase {
	...
	public void TC_12_MPAdvMixersOpptyApprovalProcess2_SalesMg(String Username, String Password, String LoginUser,
		...
		WebElement VariancefromGeneratedDiscount = driver.findElement(By.xpath(
