...
public class TC_MPBidwellOpptyApprovalProcess3 extends TestBase {
	...
	public void TC_15_MPBidwellOpptyApprovalProcess3(String Username, String Password, String LoginUser, String AccountStatus, String AccountHolder,
		...
		WebElement VariancefromGeneratedDiscount = driver
				.findElement(By.xpath("(//span[contains(text(),'Variance from Generated Discount')]//following::lightning-formatted-text)[1]"));
		String VarianceGeneratedDiscount = VariancefromGeneratedDiscount.getText();
		String ActualGeneratedDiscountNumber=VarianceGeneratedDiscount.replaceAll("[^.\\s0-9\\s]", "");
		String ExpectedGeneratedDiscount="50000";
		double num2 = Math.round(Double.parseDouble(ActualGeneratedDiscountNumber) * 100.0) / 100.0;
		Thread.sleep(2000);
		double num1 = Math.round(Double.parseDouble(ExpectedGeneratedDiscount) * 100.0) / 100.0;
		Thread.sleep(1000);
		if (num2>num1) {
