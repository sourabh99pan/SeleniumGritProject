...
public class TC_MPCBIStandardOtherOwnersProcess extends TestBase {
	...
	public void TC_16_MPCBIStandardOtherOwnersProcess(String Username, String Password, String LoginUser, String AccountStatus, String AccountHolder,
		...
		WebElement StdDiscountVariance = driver
		...
		if (num2>=num1) {
			test.pass("RSM threshold value greater then expected'" + ExpectedTotalStandardDiscountVariance + "' successfully");
		} else {
			test.fail("RSM threshold value not greater then expected'" + ExpectedTotalStandardDiscountVariance);
		}
		
		//Customer Type
		WebElement CustomerType1 = driver
				.findElement(By.xpath("(//span[contains(text(),'Customer Type')]//following::lightning-formatted-text)[1]"));
		...
		//opportunity brand
		WebElement opportunityBrand = driver
				.findElement(By.xpath("(//span[contains(text(),'Customer Type')]//following::lightning-formatted-text)[1]"));
