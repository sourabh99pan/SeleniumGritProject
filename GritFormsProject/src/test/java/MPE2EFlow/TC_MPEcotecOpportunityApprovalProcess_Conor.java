...
public class TC_MPEcotecOpportunityApprovalProcess_Conor extends TestBase {
	...
	public void TC_20_MPEcotecOpportunityApprovalProcess_Conor(String Username, String Password, String LoginUser,
		...
		WebElement totalStdDiscount = driver.findElement(By.xpath(
				"(//span[contains(text(),'Total Standard Discount Variance')]//following::lightning-formatted-text)[2]"));
