...
public class TC_MPFuchsOpportunityDOA_RoW25_MHL_Commsn extends TestBase {
	...
	public void TC_29_MPFuchsOpportunityDOA_RoW25_MHL_Commsn(String Username, String Password, String LoginUser, String AccountStatus, String AccountHolder,
		...
		if (DOAValue.contains(DOAPercentage)) {
			test.pass("DOA percentage value Matchs'" + DOAValue + "' successfully");
		} else {
			test.fail("DOA percentage value does not Matchs'" + DOAValue);
		}
