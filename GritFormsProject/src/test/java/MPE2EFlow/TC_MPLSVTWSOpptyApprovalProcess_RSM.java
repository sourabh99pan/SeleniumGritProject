	...
	public class TC_MPLSVTWSOpptyApprovalProcess_RSM extends TestBase {
		...
		public void TC_50_MPLSVTWSOpptyApprovalProcess_RSM(String Username, String Password, String LoginUser,
			...
			WebElement VariancefromRSMThreshold = driver.findElement(By.xpath(
					"(//span[contains(text(),'Variance from RSM Threshold')]//following::lightning-formatted-text)[1]"));
