...
public class TC_MPMPSAmericasCRSMorSCM extends TestBase {
	...
	public void TC_52_MPMPSAmericasCRSMorSCM(String Username, String Password, String LoginUser, String AccountStatus, String AccountHolder,
		...
		WebElement VariancefromRSMThreshold = driver
				.findElement(By.xpath("(//span[contains(text(),'Max Standard Discount Variance')]//following::lightning-formatted-text)[1]"));
