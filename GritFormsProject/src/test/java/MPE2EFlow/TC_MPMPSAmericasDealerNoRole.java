...
public class TC_MPMPSAmericasDealerNoRole extends TestBase {
	...
	public void TC_53_MPMPSAmericasDealerNoRole(String Username, String Password, String LoginUser, String AccountStatus, String AccountHolder,
		...
		WebElement VariancefromRSMThreshold = driver
				.findElement(By.xpath("(//span[contains(text(),'Max Standard Discount Variance')]//following::span)[1]"));
