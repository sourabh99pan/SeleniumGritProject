...
public class TC_MPTWSOpportunityApprovalProcess extends TestBase {
	...
	public void TC_60_MPTWSOpportunityApprovalProcess(String Username, String Password, String LoginUser, String AccountStatus, String AccountHolder,
		...
		WebElement totalStdDiscount = driver
				.findElement(By.xpath("(//span[contains(text(),'Total Standard Discount Variance')]//following::lightning-formatted-text)[2]"));
